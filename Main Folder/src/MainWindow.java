...
public class MainWindow {
    public static void main(String[] args) throws SQLException {
        ...
        ConnectDB.createTable(conn,"volunteer", "create table volunteer(first_name varchar(20), last_name varchar(20), phone int(10), location varchar(20), admin BOOLEAN);");
        ...
        ConnectDB.storeData(conn,"volunteer","insert into dbso.volunteer values(\"Itzhik\", \"Israeli\", 25, \"Yavne\", \"1\");");
    }
}
